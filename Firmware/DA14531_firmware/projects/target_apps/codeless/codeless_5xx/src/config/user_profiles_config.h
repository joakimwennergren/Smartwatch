...
/***************************************************************************************/
#if defined(__DA14535__) || defined(__DA14585__) || defined(__DA14586__)
//For these targets there is enough ram to include DISS unconditionally
#define CFG_PRF_DISS
#elif defined(__DA14531_01__)
#if  !defined (__CC_ARM) && !defined(__ARMCC_VERSION)
//For DA14531_01 and gcc compiler there is not enough ram to include DISS
#undef CFG_PRF_DISS
#else
//For DA14531_01 and arm compiler there is enough ram to include DISS
#define CFG_PRF_DISS
#endif
#else
//For DA14531 there is not enough ram available for DISS
#undef CFG_PRF_DISS
#endif
