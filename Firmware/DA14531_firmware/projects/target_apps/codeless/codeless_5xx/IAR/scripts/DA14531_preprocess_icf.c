 ...
 * Exchange memory
 ********************************************************************************************/
#define EXCH_MEM_BASE_ADDR  ALIGN4_HI(__SCT_BLE_BASE)
#define EXCH_MEM_SIZE       (__SCT_BLE_BASE + __SCT_EM_BLE_END) - EXCH_MEM_BASE_ADDR

#define EXCH_MEM_INTERIM_LIM ALIGN4_HI(EXCH_MEM_TX_CNTL_BUFFER_BASE_ADDR)
...
/***************************************************************************************/
    ...
    #define USE_REUSE_STARTUP_CODE_RAM 1
#else
    #define USE_REUSE_STARTUP_CODE_RAM 0
#endif
...
int use_reuse_startup_code_ram = USE_REUSE_STARTUP_CODE_RAM;

#if USE_REUSE_STARTUP_CODE_RAM
int exch_mem_base_addr     = EXCH_MEM_BASE_ADDR;
int exch_mem_size          = EXCH_MEM_SIZE;
int exch_mem_interim_lim   = EXCH_MEM_INTERIM_LIM;
#elif (CFG_MAX_TX_PACKET_LENGTH > 27)
