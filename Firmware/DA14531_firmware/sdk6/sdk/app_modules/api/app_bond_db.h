...
// SPI FLASH and I2C EEPROM data offset
        ...
        #define APP_BOND_DB_DATA_OFFSET     (0x1D000) // This sector and the next will be used
    #elif defined(__DA14531__)
        #define APP_BOND_DB_DATA_OFFSET     (0x13000) // This sector and the next will be used
    #else
...
/// Max number of bonded peers
    ...
    #elif defined (__DA14531__) 
        #define APP_BOND_DB_MAX_BONDED_PEERS    (1)
    #else 
...
struct bond_db
{
    ...
    uint8_t persistence[APP_BOND_DB_MAX_BONDED_PEERS];
    uint16_t end_hdr;
};
...
/**
 ****************************************************************************************
 * @brief Retrieve the bonding database entry 
 * @param[in] index   The index/slot to retrieve the entry from
 * @return An app_sec_bond_data_env_tag pointer containing all the slot information
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Change the persistence status of a database entry
 * @param[in] index, the bonding database slot    
 * @param[in] new_persistence, the new persistence value
 * @return None 
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Change the persistence status of all entries     
 * @param[in] new_persistence, the new persistence value
 * @return None 
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Get the persistence status of all entries     
 * @param[in] response, a string where the perisistence status is returned
 * @return None 
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Update bond data timestamp on bluetooth connection - SUPBLE 6830
 * @param[in] slot_to_update     The bond database slot where the timestamp will 
                                 be updated
 * @return none
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Retrieve the timestamp of the entry in slot slot_to_read
 * @param[in] slot_to_read   The slot for which the timestamp should be returned
 * @return timestamp of the current slot
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Retrieve the persistence of the entry in slot slot_to_read
 * @param[in] slot_to_read   The slot for which the persistence will be returned
 * @return persistence of the current slot
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Update bond data entry along with the persistence and timestamp 
 * @param[in] data       The relevant bonding data
 * @param[in] timestamp  The imported timestamp for this entry
 * @param[in] timestamp  The imported persistence for this entry
 * @return None
 ****************************************************************************************
 */
void app_bdb_add_entry_with_persistence_and_timestamp(struct app_sec_bond_data_env_tag *data, 
