...
const process_event_func_t app_process_handlers[] = {
        ...
        (process_event_func_t) app_gap_process_handler_with_rssi,
    #elif defined(__DA14531__) && !defined(__DA14531_01__) && !defined(__DA14535__) && defined(CFG_DATAPMP)
        (process_event_func_t) app_gap_process_handler_with_bkpt_bypass,
    #else
