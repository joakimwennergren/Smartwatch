...
#if defined (CFG_USE_DATA_PATCH_2)
...
int PATCHED_lld_data_ind_handler(ke_msg_id_t const msgid, struct lld_data_ind const *param,
                                 ke_task_id_t const dest_id, ke_task_id_t const src_id);
...
bool lld_force_timeout_refresh[BLE_CONNECTION_MAX]  __SECTION_ZERO("retention_mem_area0");
...
static const void * const patch_orig_table[] = {
    (void *) llm_con_req_ind,                   // original function 1
    0, // reserved

    (void *) smpc_recv_pair_rand_pdu,           // original function 2
    0, // reserved

    (void *) smpc_recv_public_key_exchange_pdu, // original function 3
    0, // reserved

#if (USE_SKIP_SLAVE_LATENCY)
    (void *) lld_evt_schedule_next,             // original function 4
     0, // reserved
#endif

#if (USE_HEAP_LOG)
    (void *) ke_free,                           // original function 5
    0, // reserved

    (void *) ke_malloc,                         // original function 6
    0, // reserved
#endif
