...
#if defined(CFG_CUSTOM_SCATTER_FILE) && (ALL_RAM_BLOCKS == 0xC0)
    #define ALL_RAM_RETAINED         (1)
#else
    #define ALL_RAM_RETAINED         (0)
#endif
#else
    #define ALL_RAM_BLOCKS           (RAM_1_BLOCK | RAM_2_BLOCK | RAM_3_BLOCK | RAM_4_BLOCK)
#if defined(CFG_CUSTOM_SCATTER_FILE) && (ALL_RAM_BLOCKS == 0x0F)
    #define ALL_RAM_RETAINED         (1)
#else
    #define ALL_RAM_RETAINED         (0)
#endif
