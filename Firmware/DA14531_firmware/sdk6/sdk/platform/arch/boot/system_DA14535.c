 ...
 *
 * Copyright (C) 2019-2022 Modified by Renesas Electronics Corporation and/or its affiliates.
 */
...
#include "otp_cs.h"
#include "arch.h"
#if (USE_TRNG) && defined(CFG_REUSE_STARTUP_CODE_RAM)
#include "arch_rom.h"
#endif
...
#if (USE_TRNG) && defined(CFG_REUSE_STARTUP_CODE_RAM) && defined (__ARMCC_VERSION)
#define SYSTEM_INIT  _SystemInit
#else
...
#if defined (__DA14535__) && !defined (__EXCLUDE_ROM_SYSTEM_DA14535__)
/*
...
void SYSTEM_INIT (void)
{
    ...
    // vector table residing in ER_IROM1 (see DA14535 scatter for details)
...
#if (USE_TRNG) && defined(CFG_REUSE_STARTUP_CODE_RAM) && defined (__ARMCC_VERSION)
/* SystemInit is called before scatter loading, hence it must not use the stack since it will
 * overwrite the startup code. This inline assembly function overcomes the autogenerated code
 * to avoid this. To keep the original LR, R10 isused the contents of which are not important
 * at this stage */
#if defined (__ARMCC_VERSION) && (__ARMCC_VERSION >= 6100100)
__SECTION("system_DA14xxx")
#endif
__attribute__((noinline, naked)) void SystemInit (void)
{
    __ASM volatile ("MOV     R10, LR \n"
                    "LDR     R0, in_1 \n"
                    "BLX     R0 \n"
                    "LDR     R0, in_2 \n"
                    "BLX     R0 \n"
                    ...
                    "BX      LR \n"
                    ".balign 4 \n"
                    "in_1: .word _SystemInit \n"
                    "in_2: .word fill_dbheap_random_data \n"
    : : "i" (_SystemInit), "i" (fill_dbheap_random_data) : );
}
#endif
#endif // __EXCLUDE_ROM_SYSTEM_DA14535__
