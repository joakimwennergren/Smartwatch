 ...
 * @file rf_531.c
 *
 * @brief RF functions DA14531/535
 *
...
extern void _WAIT10(void);
extern void _WAIT100(void);
extern void _WAIT400(void);
extern void _WAIT1000(void);
...
#define WAIT10()    _WAIT10()
/// WAIT100 Delay routine
#define WAIT100()   _WAIT100()
/// WAIT400 Delay routine
#define WAIT400()   _WAIT400()
/// WAIT1000 Delay routine
#define WAIT1000()   _WAIT1000()
///@}


#if defined(RF_OPT)
    #define IDENTIF static
#else
    #define IDENTIF
#endif // RF_OPT

#if defined(RF_OPT)
volatile uint8_t  pa_en_dcf_tx_setting;
#else
#if defined(CFG_INCLUDE_CAL_RES)
...
#if !defined (__DA14531_01__) && !defined (__DA14535__) || defined (__EXCLUDE_ROM_RF_531__)
#if defined(RF_OPT)
static void dis_hclk(void);
static void en_hclk(void);
static uint32_t kdtc_cal_init(void);
static void kdtc_cal_end(uint32_t fsm_ctrl_reg);
static void en_kdtc_cal_mod1(void);
static void en_kdtc_cal_mod0(void);
static void dis_kdtc_cal(void);
static void en_adpll_tx(void);
static void dis_adpll(void);
#endif // RF_OPT
#endif

#if defined (CFG_ENHANCED_TX_PWR_CTRL)
static rf_tx_pwr_lvl_t rf_tx_pwr_conn_lvl[CFG_MAX_CONNECTIONS]  __SECTION_ZERO("retention_mem_area0");
#endif

#if defined (__DA14531_01__) && !defined (__EXCLUDE_ROM_RF_531__)
// Required DA14531-01 ROM symbols
extern void set_recommended_settings_part1_ROM(void);
extern void set_recommended_settings_part2_ROM(void);
#endif // __EXCLUDE_ROM_RF_531__
...
const masked_reg16_t masked_reg16[] = {
    { ADPLL_ANA_CTRL_REG,           0x7F00, 0x8B7B },   // Register: ADPLL_ANA_CTRL_REG. TrimFields: NONE. PrefValues: DTCOFFSET=0xB. ResValues: -=0x0,DTC_LDO_DMY=0x0,-=0x0,VPASETTLE=0x2,-=0x0,TDC_OFFSET=0x15,DTC_EN=0x1,DTCOFFSET=0x0,TGLDETEN=0x0,EN_CKDCOMOD=0x1,INV_CKDCOMOD=0x1,INV_CKPHV=0x1,INV_CKTDC=0x1,TDC_INV=0x0,TDC_CKVIN_EN=0x1,TDC_DTCIN_EN=0x1. Location: D2632AC/r_radio_2632_01/r_adpll_2632_00/r_adplldig2632_00
    { ADPLL_OVERRULE_CTRL1_REG,     0x0300, 0x0300 },   // Register: ADPLL_OVERRULE_CTRL1_REG. TrimFields: NONE. PrefValues: OVR_VPAEN_WR=0x1,OVR_VPAEN_SEL=0x1. ResValues: OVR_DTC_OH_WR=0x0,OVR_DTC_OH_SEL=0x0,-=0x0,OVR_DCOAMP_WR=0x0,OVR_DCOAMP_SEL=0x0,-=0x0,OVR_DCOAMPHOLD_WR=0x0,OVR_DCOAMPHOLD_SEL=0x0,OVR_RDYFORDIV_WR=0x0,OVR_RDYFORDIV_SEL=0x0,OVR_VPAEN_WR=0x0,OVR_VPAEN_SEL=0x0,OVR_SRESETN_WR=0x0,OVR_SRESETN_SEL=0x0,OVR_ENPAIN_WR=0x0,OVR_ENPAIN_SEL=0x0,OVR_RXBIT_WR=0x0,OVR_RXBIT_SEL=0x0,OVR_ACTIVE_WR=0x0,OVR_ACTIVE_SEL=0x0. Location: D2632AC/r_radio_2632_01/r_adpll_2632_00/r_adplldig2632_00
    { ADPLL_RFPT_CTRL_REG,          0x0010, 0x0010 },   // Register: ADPLL_RFPT_CTRL_REG. TrimFields: NONE. PrefValues: INV_CKRFPT=0x1. ResValues: -=0x0,-=0x0,RFPT_RATE=0x0,INV_CKRFPT=0x0,RFPT_MUX=0x0. Location: D2632AC/r_radio_2632_01/r_adpll_2632_00/r_adplldig2632_00
    { ADPLL_TXMOD_CTRL_REG,         0x0001, 0x0001 },   // Register: ADPLL_TXMOD_CTRL_REG. TrimFields: NONE. PrefValues: BT_SEL=0x1. ResValues: INV_CKMODEXT=0x0,TX_MODE=0x0,-=0x0,EO_PACKET_DIS=0x0,MOD_INDEX=0x0,TX_DATA_INV=0x0,BT_SEL=0x0. Location: D2632AC/r_radio_2632_01/r_adpll_2632_00/r_adplldig2632_00
    { RF_AFC_CTRL_REG,              0x03F0, 0x02F5 },   // Register: RF_AFC_CTRL_REG. TrimFields: NONE. PrefValues: AFC_SYNCF_DIRECT=0x1,APD_MODE=0x3,PAD_MODE=0x3. ResValues: -=0x0,AFC_SYNCF_DIRECT=0x0,APD_MODE=0x0,PAD_MODE=0x1,AFC_MODE=0x5. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
    { RF_AGC_CTRL2_REG,             0x1E01, 0x128C },   // Register: RF_AGC_CTRL2_REG. TrimFields: NONE. PrefValues: AGC_MAX_SETTING=0x9,FASTAGC_EN=0x0. ResValues: EN_FRZ_GAIN=0x1,AGCSETTING_WR=0x0,AGCSETTING_SEL=0x0,-=0x0,AGC_MAX_SETTING=0xA,AGCDEC_WAIT=0x1,AGCINC_WAIT=0x0,FASTAGC_WAIT=0x1,FASTAGC_STEPS=0x2,FASTAGC_EN=0x1. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
    { RF_AGC_LUT_89AB_REG,          0xE0FC, 0x7773 },   // Register: RF_AGC_LUT_89AB_REG. TrimFields: NONE. PrefValues: LNA_GAIN9=0x3,LNA_GAIN8=0x3,VGA1_GAIN8=0x4. ResValues: LNA_GAIN11=0x3,VGA1_GAIN11=0x5,VGA2_GAIN11=0x3,LNA_GAIN10=0x3,VGA1_GAIN10=0x5,VGA2_GAIN10=0x3,LNA_GAIN9=0x2,VGA1_GAIN9=0x5,VGA2_GAIN9=0x3,LNA_GAIN8=0x1,VGA1_GAIN8=0x5,VGA2_GAIN8=0x3. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
    { RF_CNTRL_TIMER_19_REG,        0x00FF, 0x0855 },   // Register: RF_CNTRL_TIMER_19_REG. TrimFields: NONE. PrefValues: SET_OFFSET=0x55. ResValues: RESET_OFFSET=0x8,SET_OFFSET=0x50. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00/rfcu2522_power_00
    { RF_ENABLE_CONFIG14_REG,       0x03E0, 0x02C0 },   // Register: RF_ENABLE_CONFIG14_REG. TrimFields: NONE. PrefValues: RFIO_TX_EN_DCF_TX=0x16. ResValues: RFIO_TX_EN_DCF_TX=0xE,RFIO_TX_EN_DCF_RX=0x0. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00/rfcu2522_power_00
    { RF_ENABLE_CONFIG17_REG,       0x03E0, 0x0250 },   // Register: RF_ENABLE_CONFIG17_REG. TrimFields: NONE. PrefValues: RFIO_BIAS_SH_OPEN_DCF_TX=0x12. ResValues: RFIO_BIAS_SH_OPEN_DCF_TX=0x10,RFIO_BIAS_SH_OPEN_DCF_RX=0x10. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00/rfcu2522_power_00
    { RF_ENABLE_CONFIG18_REG,       0x03E0, 0x02A0 },   // Register: RF_ENABLE_CONFIG18_REG. TrimFields: NONE. PrefValues: PA_RAMP_EN_DCF_TX=0x15. ResValues: PA_RAMP_EN_DCF_TX=0xD,PA_RAMP_EN_DCF_RX=0x0. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00/rfcu2522_power_00
    { RF_ENABLE_CONFIG19_REG,       0x03E0, 0x02C0 },   // Register: RF_ENABLE_CONFIG19_REG. TrimFields: NONE. PrefValues: PA_EN_DCF_TX=0x16. ResValues: PA_EN_DCF_TX=0xE,PA_EN_DCF_RX=0x0. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00/rfcu2522_power_00
    { RF_ENABLE_CONFIG34_REG,       0x03E0, 0x0300 },   // Register: RF_ENABLE_CONFIG34_REG. TrimFields: NONE. PrefValues: ADPLL_LOBUF_PA_EN_DCF_TX=0x18. ResValues: ADPLL_LOBUF_PA_EN_DCF_TX=0xE,ADPLL_LOBUF_PA_EN_DCF_RX=0x0. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00/rfcu2522_power_00
    { RF_ENABLE_CONFIG39_REG,       0x001F, 0x0019 },   // Register: RF_ENABLE_CONFIG39_REG. TrimFields: NONE. PrefValues: DEM_SIGDETECT_EN_DCF_RX=0x19. ResValues: SPARE_DEM_SIGDETECT_EN_DCF_TX=0x0,DEM_SIGDETECT_EN_DCF_RX=0x13. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00/rfcu2522_power_00
    { RF_IFF_CTRL_REG,              0x6000, 0x2001 },   // Register: RF_IFF_CTRL_REG. TrimFields: NONE. PrefValues: IFF_DCOC_DAC_REFCUR_CTRL=0x1. ResValues: IFF_DCOC_DAC_REFCUR_CTRL=0x0,IFF_COMPLEX_DIS=0x0,RF_IFF_CTRL_SPARE=0x0,IFF_DCOC_DAC_DIS=0x0,IF_MUTE=0x0,IF_CAL_TRIM=0x1. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00
    { RF_LNA_CTRL3_REG,             0x0007, 0x1113 },   // Register: RF_LNA_CTRL3_REG. TrimFields: LNA_MODE_GAIN4_LP,LNA_MODE_GAIN3_LP,LNA_MODE_GAIN2_LP,LNA_MODE_GAIN1_LP,LNA_MODE_GAIN0_LP. PrefValues: LNA_TRIM_CASC=0x3. ResValues: LNA_SPARE=0x0,LNA_MODE_GAIN4_LP=0x1,LNA_MODE_GAIN3_LP=0x1,LNA_MODE_GAIN2_LP=0x1,LNA_MODE_GAIN1_LP=0x1,LNA_MODE_GAIN0_LP=0x1,-=0x0,LNA_TRIM_CASC=0x4. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00
};

const masked_reg32_t masked_reg32[] = {
    { ADPLL_DIV_CTRL_REG,   0x0001FF00, 0x01982003 },   // Register: ADPLL_DIV_CTRL_REG. TrimFields: TXDIV_TRIM. PrefValues: RXDIV_TRIM=0x20. ResValues: -=0x0,TXDIV_TRIM=0xCC,RXDIV_TRIM=0xFF,-=0x0,RXDIV_FB_EN_TX=0x0,RXDIV_FB_EN_RX=0x1,FBDIV_EN=0x1. Location: D2632AC/r_radio_2632_01/r_adpll_2632_00/r_adplldig2632_00
    { RF_AGC_CTRL1_REG,     0x001FFFFF, 0x005A5809 },   // Register: RF_AGC_CTRL1_REG. TrimFields: NONE. PrefValues: AGC_TH2_HIGH=0x69,AGC_TH_HIGH=0x30,AGC_TH_LOW=0x9. ResValues: -=0x0,AGC_MODE=0x2,AGC_TH2_HIGH=0x5B,AGC_TH_HIGH=0x2A,AGC_TH_LOW=0xD. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
    { RF_AGC_LUT_0123_REG,  0xFFFF1F1F, 0x49290908 },   // Register: RF_AGC_LUT_0123_REG. TrimFields: NONE. PrefValues: LNA_GAIN3=0x2,VGA1_GAIN3=0x2,VGA2_GAIN3=0x1,LNA_GAIN2=0x1,VGA1_GAIN2=0x2,VGA2_GAIN2=0x1,VGA1_GAIN1=0x2,VGA2_GAIN1=0x1,VGA1_GAIN0=0x2,VGA2_GAIN0=0x0. ResValues: LNA_GAIN3=0x1,VGA1_GAIN3=0x0,VGA2_GAIN3=0x3,LNA_GAIN2=0x0,VGA1_GAIN2=0x0,VGA2_GAIN2=0x3,LNA_GAIN1=0x0,VGA1_GAIN1=0x0,VGA2_GAIN1=0x2,LNA_GAIN0=0x0,VGA1_GAIN0=0x0,VGA2_GAIN0=0x1. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
    { RF_AGC_LUT_4567_REG,  0xFCFCFFFF, 0x6F6B6A69 },   // Register: RF_AGC_LUT_4567_REG. TrimFields: NONE. PrefValues: LNA_GAIN7=0x3,VGA1_GAIN7=0x3,LNA_GAIN6=0x3,VGA1_GAIN6=0x2,LNA_GAIN5=0x3,VGA1_GAIN5=0x2,VGA2_GAIN5=0x2,LNA_GAIN4=0x3,VGA1_GAIN4=0x2,VGA2_GAIN4=0x1. ResValues: LNA_GAIN7=0x1,VGA1_GAIN7=0x4,VGA2_GAIN7=0x3,LNA_GAIN6=0x1,VGA1_GAIN6=0x3,VGA2_GAIN6=0x3,LNA_GAIN5=0x1,VGA1_GAIN5=0x2,VGA2_GAIN5=0x3,LNA_GAIN4=0x1,VGA1_GAIN4=0x1,VGA2_GAIN4=0x3. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
    { RF_AGC_LUT_CDEF_REG,  0x1F1F1F1F, 0x080A2A4B },   // Register: RF_AGC_LUT_CDEF_REG. TrimFields: NONE. PrefValues: VGA1_GAIN15=0x2,VGA2_GAIN15=0x0,VGA1_GAIN14=0x2,VGA2_GAIN14=0x2,VGA1_GAIN13=0x2,VGA2_GAIN13=0x2,VGA1_GAIN12=0x2,VGA2_GAIN12=0x3. ResValues: LNA_GAIN15=0x0,VGA1_GAIN15=0x0,VGA2_GAIN15=0x1,LNA_GAIN14=0x0,VGA1_GAIN14=0x0,VGA2_GAIN14=0x2,LNA_GAIN13=0x1,VGA1_GAIN13=0x0,VGA2_GAIN13=0x2,LNA_GAIN12=0x2,VGA1_GAIN12=0x0,VGA2_GAIN12=0x3. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
    { RF_DEM_ATTR_REG,      0x011F9BD0, 0x01C63A1F },   // Register: RF_DEM_ATTR_REG. TrimFields: NONE. PrefValues: ADDR_TIMEOUT_X2=0x1,RSSI_TH=0xC,DCOC_SPEED8M_EN=0x1,AGC_SPEED8M_EN=0x1,MATCH0101_TH=0x8,RXDATA_INV=0x1. ResValues: -=0x0,ADDR_TIMEOUT_X2=0x0,RFADC_CLK_PHASE=0x3,RSSI_TH=0x9,DCPOLE=0x1,DCOC_SPEED8M_EN=0x0,AGC_SPEED8M_EN=0x0,-=0x0,MATCH0101_TH=0x6,DEM_HSI_POL=0x0,RXDATA_INV=0x0,AFC_POLE2=0x3,AFC_POLE1=0x3. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
};

static void my_SetWordMasked32(const masked_reg32_t *p)
{
    SetWordMasked32(p->addr, p->mask, p->data);
}

static void my_SetWordMasked16(const masked_reg16_t *p)
{
    SetWordMasked16(p->addr, p->mask, p->data);
}

static void set_masked_recommended_settings(void)
{
    for (int i = 0; i < sizeof(masked_reg32)/sizeof(masked_reg32_t); i++) {
        my_SetWordMasked32(&masked_reg32[i]);
    }

    for (int i = 0; i < sizeof(masked_reg16)/sizeof(masked_reg16_t); i++) {
        my_SetWordMasked16(&masked_reg16[i]);
    }
}
#endif // RF_OPT
...
// Device             : D3081AB MFix from: D3081AA
// Package            : WQFN 22
// Operating Mode     : Default opmode, no dependency on opmode.
// Delta or All       : All, all preferred settings are included (regardless if they are fallbacks to Any package / Default).
// Last change date   : September 19, 2023 - 17:12:12
// File date          : October 31, 2023 - 12:57:26


    // Register: ADPLL_ACC_CTRL_REG. TrimFields: CLIP_MOD_TUNE_0_TX,CLIP_MOD_TUNE_0_RX. PrefValues: NONE. ResValues: EN_CMF_AVG=0x1,-=0x0,CLIP_MOD_TUNE_0_TX=0xBF4,-=0x0,CLIP_MOD_TUNE_0_RX=0xBF4. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    SetWordMasked32(ADPLL_ANA_CTRL_REG, 0x00007F00, 0x02158B7B); // Register: ADPLL_ANA_CTRL_REG. TrimFields: NONE. PrefValues: DTCOFFSET=0xB. ResValues: -=0x0,RXDIV_LKGFIX_DIS=0x0,-=0x0,VPASETTLE=0x2,-=0x0,TDC_OFFSET=0x15,DTC_EN=0x1,DTCOFFSET=0x0,TGLDETEN=0x0,EN_CKDCOMOD=0x1,INV_CKDCOMOD=0x1,INV_CKPHV=0x1,INV_CKTDC=0x1,TDC_INV=0x0,TDC_CKVIN_EN=0x1,TDC_DTCIN_EN=0x1. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    SetWordMasked32(ADPLL_DCOAMP_CAL_CTRL_REG, 0xFFFF0000, 0x66660011); // Register: ADPLL_DCOAMP_CAL_CTRL_REG. TrimFields: NONE. PrefValues: DCOAMPIC_LP_TX=0x6,DCOAMPIC_LP_RX=0x6,DCOAMPIC_HP_TX=0x6,DCOAMPIC_HP_RX=0x6. ResValues: DCOAMPIC_LP_TX=0x7,DCOAMPIC_LP_RX=0x7,DCOAMPIC_HP_TX=0x7,DCOAMPIC_HP_RX=0x7,-=0x0,DCOAMPTM=0x0,AMPCALEN=0x0,KMEDIUM=0x2,KCOARSE=0x1. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    SetWordMasked32(ADPLL_DIV_CTRL_REG, 0x0001FF00, 0x01980003); // Register: ADPLL_DIV_CTRL_REG. TrimFields: TXDIV_TRIM. PrefValues: RXDIV_TRIM=0x0. ResValues: -=0x0,TXDIV_TRIM=0xCC,RXDIV_TRIM=0xFF,-=0x0,RXDIV_FB_EN_TX=0x0,RXDIV_FB_EN_RX=0x1,FBDIV_EN=0x1. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    // Register: ADPLL_KDCO_CAL_CTRL1_REG. TrimFields: KDCOHFIC_1M. PrefValues: NONE. ResValues: KDCOLF_IN_1M=0x9B,KDCOHFIC_1M=0x9B. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    // Register: ADPLL_KDCO_CAL_CTRL2_REG. TrimFields: KMOD_ALPHA_1M. PrefValues: NONE. ResValues: KDCOESTDEV=0x1,KDCOCALTX=0x0,KDCOCALRX=0x0,KDCOLFCALEN=0x1,TKDCOCAL=0x4,-=0x0,KDCOCN_IC=0x14,-=0x0,-=0x0,KMOD_ALPHA_1M=0xA. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    // Register: ADPLL_KDTCTDC_CAL_CTRL1_REG. TrimFields: KDTCIC,KDTC_ALPHA. PrefValues: NONE. ResValues: KDTCIC=0x10A,KDTCCN_IC=0x14,KDTC_PIPELINE_BYPASS=0x0,KTDC_IN=0x10A,KDTC_ALPHA=0x1C. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    SetWordMasked32(ADPLL_OVERRULE_CTRL1_REG, 0x00000300, 0x00000300); // Register: ADPLL_OVERRULE_CTRL1_REG. TrimFields: NONE. PrefValues: OVR_VPAEN_WR=0x1,OVR_VPAEN_SEL=0x1. ResValues: OVR_DTC_OH_WR=0x0,OVR_DTC_OH_SEL=0x0,-=0x0,OVR_DCOAMP_WR=0x0,OVR_DCOAMP_SEL=0x0,-=0x0,OVR_DCOAMPHOLD_WR=0x0,OVR_DCOAMPHOLD_SEL=0x0,OVR_RDYFORDIV_WR=0x0,OVR_RDYFORDIV_SEL=0x0,OVR_VPAEN_WR=0x0,OVR_VPAEN_SEL=0x0,OVR_SRESETN_WR=0x0,OVR_SRESETN_SEL=0x0,OVR_ENPAIN_WR=0x0,OVR_ENPAIN_SEL=0x0,OVR_RXBIT_WR=0x0,OVR_RXBIT_SEL=0x0,OVR_ACTIVE_WR=0x0,OVR_ACTIVE_SEL=0x0. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    SetWordMasked16(ADPLL_RFPT_CTRL_REG, 0x0010, 0x0010); // Register: ADPLL_RFPT_CTRL_REG. TrimFields: NONE. PrefValues: INV_CKRFPT=0x1. ResValues: -=0x0,-=0x0,RFPT_RATE=0x0,INV_CKRFPT=0x0,RFPT_MUX=0x0. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    SetWordMasked16(ADPLL_TXMOD_CTRL_REG, 0x0001, 0x0001); // Register: ADPLL_TXMOD_CTRL_REG. TrimFields: NONE. PrefValues: BT_SEL=0x1. ResValues: INV_CKMODEXT=0x0,TX_MODE=0x0,-=0x0,EO_PACKET_DIS=0x0,MOD_INDEX=0x0,TX_DATA_INV=0x0,BT_SEL=0x0. Location: D3081AB/r_radio_3081_02/r_adpll_3081_01/r_adplldig_3081_00
    SetWord32(BLE_RADIOPWRUPDN_REG, 0x075C0559); // Register: BLE_RADIOPWRUPDN_REG. TrimFields: NONE. PrefValues: RTRIP_DELAY=0x7,RXPWRUP=0x5C,TXPWRDN=0x5,TXPWRUP=0x59. ResValues: RTRIP_DELAY=0x0,RXPWRUP=0xD2,TXPWRDN=0x3,TXPWRUP=0xD2. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/ble2632_00
    // Register: CLK_RC32K_REG. TrimFields: RC32K_TRIM. PrefValues: NONE. ResValues: RC32K_TRIM=0x7,RC32K_DISABLE=0x0. Location: D3081AB/D3081AB_dcore/crg_3081_00
    // Register: CLK_RC32M_REG. TrimFields: RC32M_BIAS. PrefValues: NONE. ResValues: RC32M_COSC=0xF,RC32M_RANGE=0x0,RC32M_BIAS=0x8,RC32M_DISABLE=0x0. Location: D3081AB/D3081AB_dcore/crg_3081_00
// "set in system_init()" SetWordMasked16(CLK_RCX_REG, 0x0F00, 0x0EFC); // Register: CLK_RCX_REG. TrimFields: NONE. PrefValues: RCX_BIAS=0xE. ResValues: RCX_BIAS=0xA,RCX_C0=0x1,RCX_CADJUST=0x1F,RCX_RADJUST=0x0,RCX_ENABLE=0x0. Location: D3081AB/D3081AB_dcore/crg_3081_00
// "set in system_init()" SetWordMasked16(DCDC_CTRL_REG, 0xF006, 0xF4A0); // Register: DCDC_CTRL_REG. TrimFields: NONE. PrefValues: DCDC_ILIM_MAX=0xF,DCDC_CLK_DIV=0x0. ResValues: DCDC_ILIM_MAX=0x8,DCDC_ILIM_MIN=0x4,DCDC_OK_CLR_CNT=0x2,DCDC_TIMEOUT=0x4,DCDC_CLK_DIV=0x1,DCDC_ENABLE=0x0. Location: D3081AB/D3081AB_dcore/crg_3081_00/crg_dcdc_dig_3081_00
// "set in system_init()" SetWordMasked16(GP_ADC_CTRL3_REG, 0x00FF, 0x0050); // Register: GP_ADC_CTRL3_REG. TrimFields: NONE. PrefValues: GP_ADC_EN_DEL=0x50. ResValues: GP_ADC_INTERVAL=0x0,GP_ADC_EN_DEL=0x40. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_peripheral/adc2632_00/adc2632_bif_00
    // Register: GP_ADC_TRIM_REG. TrimFields: GP_ADC_LDO_LEVEL,GP_ADC_OFFS_SH_VREF. PrefValues: NONE. ResValues: GP_ADC_LDO_LEVEL=0x3,-=0x8. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_peripheral/adc2632_00/adc2632_bif_00
// "set in system_init()" SetWordMasked16(POWER_AON_CTRL_REG, 0x4000, 0x4008); // Register: POWER_AON_CTRL_REG. TrimFields: NONE. PrefValues: FORCE_RUNNING_COMP_DIS=0x1. ResValues: FORCE_RUNNING_COMP_DIS=0x0,LDO_RET_TRIM=0x0,CMP_VCONT_SLP_DISABLE=0x0,BOOST_MODE_FORCE=0x0,CHARGE_VBAT_DISABLE=0x0,RC32K_LOW_SPEED_FORCE=0x0,RC32K_HIGH_SPEED_FORCE=0x0,POR_VBAT_HIGH_RST_MASK=0x1,POR_VBAT_LOW_RST_MASK=0x0,VBAT_HL_CONNECT_RES_CTRL=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_aon/crg_preg_aon_3081_00
// "set in system_init()" SetWordMasked16(POWER_CTRL_REG, 0x4000, 0x0000); // Register: POWER_CTRL_REG. TrimFields: NONE. PrefValues: POR_VBAT_HIGH_HYST_DIS=0x0. ResValues: VBAT_HL_CONNECT_MODE=0x0,POR_VBAT_HIGH_HYST_DIS=0x1,POR_VBAT_HIGH_HYST_SEL=0x0,POR_VBAT_HIGH_DISABLE=0x0,POR_VBAT_LOW_HYST_DIS=0x0,POR_VBAT_LOW_HYST_SEL=0x0,POR_VBAT_LOW_DISABLE=0x0,CP_DISABLE=0x0,LDO_VREF_HOLD_FORCE=0x0,LDO_LOW_CTRL_REG=0x0,LDO_CORE_DISABLE=0x0,LDO_CORE_RET_ENABLE=0x0,VBAT_HL_CONNECT=0x0,CMP_VBAT_HIGH_OK_ENABLE=0x0,CMP_VBAT_HIGH_NOK_ENABLE=0x0. Location: D3081AB/D3081AB_dcore/crg_3081_00
// "set in system_init()" SetWordMasked16(POWER_LEVEL_REG, 0x380E, 0x1A36); // Register: POWER_LEVEL_REG. TrimFields: NONE. PrefValues: DCDC_TRIM=0x3,LDO_LOW_TRIM=0x3. ResValues: DCDC_TRIM=0x5,DCDC_LEVEL=0x1,-=0x0,FORCE_RCX_LDO_CORE_RET=0x0,LDO_XTAL_TRIM=0x3,LDO_LOW_TRIM=0x7,LDO_CORE_LEVEL_BOOST=0x0. Location: D3081AB/D3081AB_dcore/crg_3081_00
    SetWordMasked16(RF_ADC_CTRL1_REG, 0x0001, 0x0001); // Register: RF_ADC_CTRL1_REG. TrimFields: NONE. PrefValues: ADC_DC_OFFSET_SEL=0x1. ResValues: ADC_SIGN=0x0,ADC_MUTE=0x0,ADC_DC_OFFSET_SEL=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
// If PWR_SW_TIM_CTRL is changed the prefetch_time and lld_evt_abort_cnt_duration entries in rom_cfg_table_var must also be changed accordingly.
//SetWordMasked16(RF_ADPLLDIG_CTRL_REG, 0x0070, 0x0030); // Register: RF_ADPLLDIG_CTRL_REG. TrimFields: NONE. PrefValues: PWR_SW_TIM_CTRL=0x3. ResValues: PWR_SW_TIM_CTRL=0x1,OPENLOOP_RDY_WR=0x0,OPENLOOP_RDY_SEL=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00

    SetWordMasked16(RF_AFC_CTRL_REG, 0x03F0, 0x02F5); // Register: RF_AFC_CTRL_REG. TrimFields: NONE. PrefValues: AFC_SYNCF_DIRECT=0x1,APD_MODE=0x3,PAD_MODE=0x3. ResValues: -=0x0,AFC_SYNCF_DIRECT=0x0,APD_MODE=0x0,PAD_MODE=0x1,AFC_MODE=0x5. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWordMasked32(RF_AGC_CTRL1_REG, 0x001FFFFF, 0x005A6009); // Register: RF_AGC_CTRL1_REG. TrimFields: NONE. PrefValues: AGC_TH2_HIGH=0x69,AGC_TH_HIGH=0x40,AGC_TH_LOW=0x9. ResValues: -=0x0,AGC_MODE=0x2,AGC_TH2_HIGH=0x5B,AGC_TH_HIGH=0x2A,AGC_TH_LOW=0xD. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWordMasked32(RF_AGC_CTRL2_REG, 0x00001E01, 0x0040128C); // Register: RF_AGC_CTRL2_REG. TrimFields: NONE. PrefValues: AGC_MAX_SETTING=0x9,FASTAGC_EN=0x0. ResValues: EN_FRZ_GAIN=0x1,AGCSETTING_WR=0x0,AGCSETTING_SEL=0x0,-=0x0,AGC_MAX_SETTING=0xA,AGCDEC_WAIT=0x1,AGCINC_WAIT=0x0,FASTAGC_WAIT=0x1,FASTAGC_STEPS=0x2,FASTAGC_EN=0x1. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWordMasked32(RF_AGC_LUT_0123_REG, 0xFFFF1F1F, 0x49290908); // Register: RF_AGC_LUT_0123_REG. TrimFields: NONE. PrefValues: LNA_GAIN3=0x2,VGA1_GAIN3=0x2,VGA2_GAIN3=0x1,LNA_GAIN2=0x1,VGA1_GAIN2=0x2,VGA2_GAIN2=0x1,VGA1_GAIN1=0x2,VGA2_GAIN1=0x1,VGA1_GAIN0=0x2,VGA2_GAIN0=0x0. ResValues: LNA_GAIN3=0x1,VGA1_GAIN3=0x0,VGA2_GAIN3=0x3,LNA_GAIN2=0x0,VGA1_GAIN2=0x0,VGA2_GAIN2=0x3,LNA_GAIN1=0x0,VGA1_GAIN1=0x0,VGA2_GAIN1=0x2,LNA_GAIN0=0x0,VGA1_GAIN0=0x0,VGA2_GAIN0=0x1. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWordMasked32(RF_AGC_LUT_4567_REG, 0xFCFCFFFF, 0x6F6B6A69); // Register: RF_AGC_LUT_4567_REG. TrimFields: NONE. PrefValues: LNA_GAIN7=0x3,VGA1_GAIN7=0x3,LNA_GAIN6=0x3,VGA1_GAIN6=0x2,LNA_GAIN5=0x3,VGA1_GAIN5=0x2,VGA2_GAIN5=0x2,LNA_GAIN4=0x3,VGA1_GAIN4=0x2,VGA2_GAIN4=0x1. ResValues: LNA_GAIN7=0x1,VGA1_GAIN7=0x4,VGA2_GAIN7=0x3,LNA_GAIN6=0x1,VGA1_GAIN6=0x3,VGA2_GAIN6=0x3,LNA_GAIN5=0x1,VGA1_GAIN5=0x2,VGA2_GAIN5=0x3,LNA_GAIN4=0x1,VGA1_GAIN4=0x1,VGA2_GAIN4=0x3. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWordMasked32(RF_AGC_LUT_89AB_REG, 0x0000E0FC, 0x77777773); // Register: RF_AGC_LUT_89AB_REG. TrimFields: NONE. PrefValues: LNA_GAIN9=0x3,LNA_GAIN8=0x3,VGA1_GAIN8=0x4. ResValues: LNA_GAIN11=0x3,VGA1_GAIN11=0x5,VGA2_GAIN11=0x3,LNA_GAIN10=0x3,VGA1_GAIN10=0x5,VGA2_GAIN10=0x3,LNA_GAIN9=0x2,VGA1_GAIN9=0x5,VGA2_GAIN9=0x3,LNA_GAIN8=0x1,VGA1_GAIN8=0x5,VGA2_GAIN8=0x3. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWordMasked32(RF_AGC_LUT_CDEF_REG, 0x1F1F1F1F, 0x080A2A4B); // Register: RF_AGC_LUT_CDEF_REG. TrimFields: NONE. PrefValues: VGA1_GAIN15=0x2,VGA2_GAIN15=0x0,VGA1_GAIN14=0x2,VGA2_GAIN14=0x2,VGA1_GAIN13=0x2,VGA2_GAIN13=0x2,VGA1_GAIN12=0x2,VGA2_GAIN12=0x3. ResValues: LNA_GAIN15=0x0,VGA1_GAIN15=0x0,VGA2_GAIN15=0x1,LNA_GAIN14=0x0,VGA1_GAIN14=0x0,VGA2_GAIN14=0x2,LNA_GAIN13=0x1,VGA1_GAIN13=0x0,VGA2_GAIN13=0x2,LNA_GAIN12=0x2,VGA1_GAIN12=0x0,VGA2_GAIN12=0x3. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00

/* RF_ATTR_REG: PA_POWER_SETTING is set by SDK
    SetWordMasked32(RF_ATTR_REG, 0x00001000, 0x0C001820); // Register: RF_ATTR_REG. TrimFields: NONE. PrefValues: TIA_BIAS=0x1. ResValues: PA_POWER_SETTING=0xC,TIA_BIAS=0x0,RF_BIAS=0x8,-=0x1,IFF_POLARITY=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
*/
#if defined (CFG_ENHANCED_TX_PWR_CTRL)
    SetWord32(RF_ATTR_REG, (0x1 << 12U) | (0x8 << 8U) | (0x1 << 5U) | (0x0 << 3U));
#else
    SetWord32(RF_ATTR_REG, (rf_tx_pwr_lvl << 24U) | (0x1 << 12U) | (0x8 << 8U) | (0x1 << 5U) | (0x0 << 3U));
#endif
    SetWord16(RF_CNTRL_TIMER_11_REG, 0x1400); // Register: RF_CNTRL_TIMER_11_REG. TrimFields: NONE. PrefValues: RESET_OFFSET=0x14,SET_OFFSET=0x0. ResValues: RESET_OFFSET=0x8,SET_OFFSET=0x1A. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_CNTRL_TIMER_12_REG, 0x1405); // Register: RF_CNTRL_TIMER_12_REG. TrimFields: NONE. PrefValues: RESET_OFFSET=0x14,SET_OFFSET=0x5. ResValues: RESET_OFFSET=0xE,SET_OFFSET=0x1A. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_CNTRL_TIMER_19_REG, 0x00FF, 0x0855); // Register: RF_CNTRL_TIMER_19_REG. TrimFields: NONE. PrefValues: SET_OFFSET=0x55. ResValues: RESET_OFFSET=0x8,SET_OFFSET=0x50. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_CNTRL_TIMER_21_REG, 0x0234); // Register: RF_CNTRL_TIMER_21_REG. TrimFields: NONE. PrefValues: RESET_OFFSET=0x2,SET_OFFSET=0x34. ResValues: RESET_OFFSET=0x0,SET_OFFSET=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_CNTRL_TIMER_22_REG, 0x0A34); // Register: RF_CNTRL_TIMER_22_REG. TrimFields: NONE. PrefValues: RESET_OFFSET=0xA,SET_OFFSET=0x34. ResValues: RESET_OFFSET=0x0,SET_OFFSET=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_CNTRL_TIMER_23_REG, 0x0851); // Register: RF_CNTRL_TIMER_23_REG. TrimFields: NONE. PrefValues: RESET_OFFSET=0x8,SET_OFFSET=0x51. ResValues: RESET_OFFSET=0x0,SET_OFFSET=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_CNTRL_TIMER_24_REG, 0x0A26); // Register: RF_CNTRL_TIMER_24_REG. TrimFields: NONE. PrefValues: RESET_OFFSET=0xA,SET_OFFSET=0x26. ResValues: RESET_OFFSET=0x0,SET_OFFSET=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_CNTRL_TIMER_25_REG, 0x0858); // Register: RF_CNTRL_TIMER_25_REG. TrimFields: NONE. PrefValues: RESET_OFFSET=0x8,SET_OFFSET=0x58. ResValues: RESET_OFFSET=0x0,SET_OFFSET=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_DC_OFFSET_CTRL3_REG, 0x140A); // Register: RF_DC_OFFSET_CTRL3_REG. TrimFields: NONE. PrefValues: DCBETA_Q=0x14,DCBETA_I=0xA. ResValues: DCBETA_Q=0xDC,DCBETA_I=0xE4. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWordMasked32(RF_DEM_ATTR_REG, 0x011FFBDC, 0x01C61A1B); // Register: RF_DEM_ATTR_REG. TrimFields: NONE. PrefValues: ADDR_TIMEOUT_X2=0x1,RSSI_TH=0xC,DCPOLE=0x0,DCOC_SPEED8M_EN=0x1,AGC_SPEED8M_EN=0x1,MATCH0101_TH=0x8,RXDATA_INV=0x1,AFC_POLE2=0x2. ResValues: -=0x0,ADDR_TIMEOUT_X2=0x0,RFADC_CLK_PHASE=0x3,RSSI_TH=0x9,DCPOLE=0x1,DCOC_SPEED8M_EN=0x0,AGC_SPEED8M_EN=0x0,-=0x0,MATCH0101_TH=0x6,DEM_HSI_POL=0x0,RXDATA_INV=0x0,AFC_POLE2=0x3,AFC_POLE1=0x3. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_dem_3081_00
    SetWord16(RF_ENABLE_CONFIG0_REG, 0x016B); // Register: RF_ENABLE_CONFIG0_REG. TrimFields: NONE. PrefValues: RFIO_LDO_EN_DCF_TX=0xB,RFIO_LDO_EN_DCF_RX=0xB. ResValues: RFIO_LDO_EN_DCF_TX=0x4,RFIO_LDO_EN_DCF_RX=0x3. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_ENABLE_CONFIG14_REG, 0x03E0, 0x02C0); // Register: RF_ENABLE_CONFIG14_REG. TrimFields: NONE. PrefValues: RFIO_TX_EN_DCF_TX=0x16. ResValues: RFIO_TX_EN_DCF_TX=0xE,RFIO_TX_EN_DCF_RX=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_ENABLE_CONFIG17_REG, 0x03E0, 0x0250); // Register: RF_ENABLE_CONFIG17_REG. TrimFields: NONE. PrefValues: RFIO_BIAS_SH_OPEN_DCF_TX=0x12. ResValues: RFIO_BIAS_SH_OPEN_DCF_TX=0x10,RFIO_BIAS_SH_OPEN_DCF_RX=0x10. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_ENABLE_CONFIG18_REG, 0x03E0, 0x02A0); // Register: RF_ENABLE_CONFIG18_REG. TrimFields: NONE. PrefValues: PA_RAMP_EN_DCF_TX=0x15. ResValues: PA_RAMP_EN_DCF_TX=0xD,PA_RAMP_EN_DCF_RX=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_ENABLE_CONFIG19_REG, 0x03E0, 0x02C0); // Register: RF_ENABLE_CONFIG19_REG. TrimFields: NONE. PrefValues: PA_EN_DCF_TX=0x16. ResValues: PA_EN_DCF_TX=0xE,PA_EN_DCF_RX=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_ENABLE_CONFIG1_REG, 0x018C); // Register: RF_ENABLE_CONFIG1_REG. TrimFields: NONE. PrefValues: PA_LDO_EN_DCF_TX=0xC,PA_LDO_EN_DCF_RX=0xC. ResValues: PA_LDO_EN_DCF_TX=0x4,PA_LDO_EN_DCF_RX=0x3. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_ENABLE_CONFIG34_REG, 0x03E0, 0x0300); // Register: RF_ENABLE_CONFIG34_REG. TrimFields: NONE. PrefValues: ADPLL_LOBUF_PA_EN_DCF_TX=0x18. ResValues: ADPLL_LOBUF_PA_EN_DCF_TX=0xE,ADPLL_LOBUF_PA_EN_DCF_RX=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_ENABLE_CONFIG39_REG, 0x001F, 0x0019); // Register: RF_ENABLE_CONFIG39_REG. TrimFields: NONE. PrefValues: DEM_SIGDETECT_EN_DCF_RX=0x19. ResValues: SPARE_DEM_SIGDETECT_EN_DCF_TX=0x0,DEM_SIGDETECT_EN_DCF_RX=0x13. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWord16(RF_ENABLE_CONFIG42_REG, 0x016B); // Register: RF_ENABLE_CONFIG42_REG. TrimFields: NONE. PrefValues: CP_EN_DCF_TX=0xB,CP_EN_DCF_RX=0xB. ResValues: CP_EN_DCF_TX=0x0,CP_EN_DCF_RX=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00/rfcu2522_power_00
    SetWordMasked16(RF_IFF_CTRL_REG, 0x6000, 0x2001); // Register: RF_IFF_CTRL_REG. TrimFields: NONE. PrefValues: IFF_DCOC_DAC_REFCUR_CTRL=0x1. ResValues: IFF_DCOC_DAC_REFCUR_CTRL=0x0,IFF_COMPLEX_DIS=0x0,RF_IFF_CTRL_SPARE=0x0,IFF_DCOC_DAC_DIS=0x0,IF_MUTE=0x0,IF_CAL_TRIM=0x1. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
    // Register: RF_LNA_CTRL1_REG. TrimFields: LNA_TRIM_GAIN4_HP,LNA_TRIM_GAIN3_HP,LNA_TRIM_GAIN2_HP,LNA_TRIM_GAIN1_HP,LNA_TRIM_GAIN0_HP. PrefValues: NONE. ResValues: LNA_TRIM_GAIN4_HP=0x10,LNA_TRIM_GAIN3_HP=0x10,LNA_TRIM_GAIN2_HP=0x10,LNA_TRIM_GAIN1_HP=0x10,LNA_TRIM_GAIN0_HP=0x10. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
    // Register: RF_LNA_CTRL2_REG. TrimFields: LNA_TRIM_GAIN4_LP,LNA_TRIM_GAIN3_LP,LNA_TRIM_GAIN2_LP,LNA_TRIM_GAIN1_LP,LNA_TRIM_GAIN0_LP. PrefValues: NONE. ResValues: LNA_TRIM_GAIN4_LP=0xD,LNA_TRIM_GAIN3_LP=0xD,LNA_TRIM_GAIN2_LP=0xD,LNA_TRIM_GAIN1_LP=0xD,LNA_TRIM_GAIN0_LP=0xD. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
    SetWordMasked32(RF_LNA_CTRL3_REG, 0x00000007, 0x00111113); // Register: RF_LNA_CTRL3_REG. TrimFields: LNA_MODE_GAIN4_LP,LNA_MODE_GAIN3_LP,LNA_MODE_GAIN2_LP,LNA_MODE_GAIN1_LP,LNA_MODE_GAIN0_LP. PrefValues: LNA_TRIM_CASC=0x3. ResValues: LNA_SPARE=0x0,LNA_MODE_GAIN4_LP=0x1,LNA_MODE_GAIN3_LP=0x1,LNA_MODE_GAIN2_LP=0x1,LNA_MODE_GAIN1_LP=0x1,LNA_MODE_GAIN0_LP=0x1,-=0x0,LNA_TRIM_CASC=0x4. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
    SetWordMasked32(RF_MIXER_CTRL1_REG, 0x01FF01FF, 0x01500150); // Register: RF_MIXER_CTRL1_REG. TrimFields: NONE. PrefValues: MIXER_IP2_DAC_Q_TRIM=0x150,MIXER_IP2_DAC_I_TRIM=0x150. ResValues: MIXER_IP2_DAC_EXTEND_RANGE=0x0,MIXER_IP2_DAC_Q_TRIM=0x10F,MIXER_IP2_DAC_I_TRIM=0x10F. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
    // Register: RF_PA_CTRL_REG. TrimFields: TRIM_DUTY_NEG,TRIM_DUTY_POS. PrefValues: NONE. ResValues: PA_RAMP_STEP_SPEED=0x3,TRIM_DUTY_NEG=0x0,TRIM_DUTY_POS=0x0. Location: D3081AB/D3081AB_dcore/D3081AA_dcore_radio/r_rfcu_3081_00
...
// Register bit-fields which have a preferred setting which relates to a different device-package-opmode combination:
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D2522AA'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D2522AB'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D2674AA'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D2763AA'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D2522AC'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D2763AB'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D3080AA'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D3080AB'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG15_REG'	BIT-FIELD: 'RFIO_TX_HARM_EN_DCF_TX'	DEVICE: 'D3080BA'	PACKAGE: 'any'	OPMODE: 'default'
// REG: 'RF_ENABLE_CONFIG38_REG'	BIT-FIELD: 'DEM_AGC_UNFREEZE_EN_DCF_RX'	DEVICE: 'D2632AA'	PACKAGE: 'any'	OPMODE: 'default'
}
...
// Operating Mode     : Default opmode, no dependency on opmode.
// Delta or All       : All, all preferred settings are included (regardless if they are fallbacks to Any package / Default).
// Last change date   : July 11, 2023 - 09:29:48
// File date          : July 11, 2023 - 10:59:09
...
#elif defined (__DA14531_01__) && !defined (__EXCLUDE_ROM_RF_531__)
void set_recommended_settings()
{
    set_recommended_settings_part1_ROM();
/* RF_ATTR_REG: PA_POWER_SETTING is set by SDK
...
*/
    ...
    SetWord32(RF_ATTR_REG, (rf_tx_pwr_lvl << 24U) | (0x1 << 12U) | (0x8 << 8U) | (0x1 << 5U) | (0x0 << 3U));
#endif
    set_recommended_settings_part2_ROM();
}
#else
void set_recommended_settings()
{
...
// Package            : All packages, no dependency on package.
// Last change date   : November 13, 2019 - 22:10:09
// Last change item   : Register: RF_DEM_ATTR_REG, Field: ADDR_TIMEOUT_X2, Value: 0x1
// File date          : November 13, 2019 - 22:40:41


#if defined(RF_OPT)
    set_masked_recommended_settings();
    SetWord16(ADPLL_DCOAMP_CAL_CTRL_REG+2, 0x8888); // Register: ADPLL_DCOAMP_CAL_CTRL_REG. TrimFields: NONE. PrefValues: DCOAMPIC_LP_TX=0x8,DCOAMPIC_LP_RX=0x8,DCOAMPIC_HP_TX=0x8,DCOAMPIC_HP_RX=0x8. ResValues: DCOAMPIC_LP_TX=0x7,DCOAMPIC_LP_RX=0x7,DCOAMPIC_HP_TX=0x7,DCOAMPIC_HP_RX=0x7,-=0x0,DCOAMPTM=0x0,AMPCALEN=0x0,KMEDIUM=0x2,KCOARSE=0x1. Location: D2632AC/r_radio_2632_01/r_adpll_2632_00/r_adplldig2632_00
#else
    ...
    SetWordMasked32(ADPLL_DIV_CTRL_REG, 0x0001FF00, 0x01982003); // Register: ADPLL_DIV_CTRL_REG. TrimFields: TXDIV_TRIM. PrefValues: RXDIV_TRIM=0x20. ResValues: -=0x0,TXDIV_TRIM=0xCC,RXDIV_TRIM=0xFF,-=0x0,RXDIV_FB_EN_TX=0x0,RXDIV_FB_EN_RX=0x1,FBDIV_EN=0x1. Location: D2632AC/r_radio_2632_01/r_adpll_2632_00/r_adplldig2632_00
...
// "set in system_init()" SetWordMasked16(CLK_RCX_REG, 0x0F00, 0x0BFC); // Register: CLK_RCX_REG. TrimFields: NONE. PrefValues: RCX_BIAS=0xB. ResValues: RCX_BIAS=0xA,RCX_C0=0x1,RCX_CADJUST=0x1F,RCX_RADJUST=0x0,RCX_ENABLE=0x0. Location: D2632AC/dcore2632_AC/crg2632_00
...
// If PWR_SW_TIM_CTRL is changed the prefetch_time and lld_evt_abort_cnt_duration entries in rom_cfg_table_var must also be changed accordingly.
//  SetWordMasked16(RF_ADPLLDIG_CTRL_REG, 0x0070, 0x0030); // Register: RF_ADPLLDIG_CTRL_REG. TrimFields: NONE. PrefValues: PWR_SW_TIM_CTRL=0x3. ResValues: PWR_SW_TIM_CTRL=0x1,OPENLOOP_RDY_WR=0x0,OPENLOOP_RDY_SEL=0x0. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_rfcu2632_00
#if !defined(RF_OPT)
...
*/
    ...
    SetWord16(RF_DC_OFFSET_CTRL3_REG, 0x0F07); // Register: RF_DC_OFFSET_CTRL3_REG. TrimFields: NONE. PrefValues: DCBETA_Q=0xF,DCBETA_I=0x7. ResValues: DCBETA_Q=0xDC,DCBETA_I=0xE4. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
#if !defined(RF_OPT)
    SetWordMasked32(RF_DEM_ATTR_REG, 0x011F9BD0, 0x01C63A1F); // Register: RF_DEM_ATTR_REG. TrimFields: NONE. PrefValues: ADDR_TIMEOUT_X2=0x1,RSSI_TH=0xC,DCOC_SPEED8M_EN=0x1,AGC_SPEED8M_EN=0x1,MATCH0101_TH=0x8,RXDATA_INV=0x1. ResValues: -=0x0,ADDR_TIMEOUT_X2=0x0,RFADC_CLK_PHASE=0x3,RSSI_TH=0x9,DCPOLE=0x1,DCOC_SPEED8M_EN=0x0,AGC_SPEED8M_EN=0x0,-=0x0,MATCH0101_TH=0x6,DEM_HSI_POL=0x0,RXDATA_INV=0x0,AFC_POLE2=0x3,AFC_POLE1=0x3. Location: D2632AC/dcore2632_AC/radio_subsystem2632_00/r_dem2632_00
#endif
...
#if defined(CODELESS_585) && defined(USE_AT_PWRLVL)
void set_power_level(void)
{
    #if defined (CFG_ENHANCED_TX_PWR_CTRL)
        SetWord32(RF_ATTR_REG, (0x1 << 12U) | (0x8 << 8U) | (0x1 << 5U) | (0x0 << 3U));
    #else
        uint32_t reg_value=(rf_tx_pwr_lvl << 24U) | (0x1 << 12U) | (0x8 << 8U) | (0x1 << 5U) | (0x0 << 3U);
        if (GetWord32(RF_ATTR_REG) != reg_value)
        {
            SetWord32(RF_ATTR_REG, reg_value);
        }
        #endif
}
#endif
...
#endif
{
...
#if defined(RF_OPT)
        uint32_t fsm_ctrl_reg = kdtc_cal_init();        // initial settings for KDTC calibration
#else
      ...
      for (int i = 0; i < 3; i++) {
        ...
        // Update the calibrated value to ADPLL

        volatile uint32_t reg = GetWord32(ADPLL_KDTCTDC_CAL_CTRL1_REG);
        reg &= ~(KDTCIC | KTDC_IN);
        reg |= (kdtc_res << SHIF32(KDTCIC)) | (kdtc_res << SHIF32(KTDC_IN));
        SetWord32(ADPLL_KDTCTDC_CAL_CTRL1_REG, reg);
//        SetBits(ADPLL_KDTCTDC_CAL_CTRL1_REG, KDTCIC, kdtc_res);
//        SetBits(ADPLL_KDTCTDC_CAL_CTRL1_REG, KTDC_IN, kdtc_res);

        if (i != 2) {
            en_kdtc_cal_mod0();     // enable KDTC calibration mode 0
        }
    }
    dis_kdtc_cal();
    kdtc_cal_end(fsm_ctrl_reg);
    dis_adpll();
    WAIT10();//delay_us(10);
#endif //RF_OPT
...
{
   // Activate LDO
    SetByte(RF_RADIO_INIT_REG, ADPLLDIG_PWR_SW1_EN);
}
...
#endif // RF_OPT
{
         ...
         */
#if defined(RF_OPT)
        uint32_t fsm_ctrl_reg = GetWord32(ADPLL_FSM_CTRL_REG);          // back up fsm_ctrl_reg register
        SetWord32(ADPLL_FSM_CTRL_REG, 0xFFFFFFFF);                      // set all fsm timing to max

        uint32_t reg = GetWord32(ADPLL_KDTCTDC_CAL_CTRL1_REG);
        reg &= ~(KDTC_ALPHA | KDTC_PIPELINE_BYPASS);
        SetWord32(ADPLL_KDTCTDC_CAL_CTRL1_REG, reg);

        reg = GetWord32(ADPLL_KDTCTDC_CAL_CTRL2_REG);
        reg &= ~(PHRDLY | KDTCCALLG);
        reg |= (2 << (SHIF32(PHRDLY)) | (4 << SHIF32(KDTCCALLG)));
        SetWord32(ADPLL_KDTCTDC_CAL_CTRL2_REG, reg);

        reg = GetWord32(ADPLL_LF_CTRL2_REG);
        reg &= ~(MODKZ | MODK_TUNE | MODTAU_TUNE);
        reg |= (22 << (SHIF32(MODKZ)) | (24 << SHIF32(MODK_TUNE)) | (24 << SHIF32(MODTAU_TUNE)));
        SetWord32(ADPLL_LF_CTRL2_REG, reg);
        return fsm_ctrl_reg;
#else
...
#endif // RF_OPT
{
        ...
        uint32_t reg = GetWord32(ADPLL_KDTCTDC_CAL_CTRL1_REG);
        reg &= ~(KDTC_ALPHA | KDTC_PIPELINE_BYPASS);
        reg |= 0x1C << (SHIF32(KDTC_ALPHA));
        SetWord32(ADPLL_KDTCTDC_CAL_CTRL1_REG, reg);

        reg = GetWord32(ADPLL_LF_CTRL2_REG);
        reg &= ~(MODKZ | MODK_TUNE | MODTAU_TUNE);
        reg |= (28 << (SHIF32(MODKZ)) | (30 << SHIF32(MODK_TUNE)) | (30 << SHIF32(MODTAU_TUNE)));
        SetWord32(ADPLL_LF_CTRL2_REG, reg);
#else
        // restore values
        SetWord32(ADPLL_FSM_CTRL_REG, fsm_ctrl_reg );                   // restore fsm_ctrl_reg register
...
IDENTIF void en_kdtc_cal_mod1(void)
{
...
IDENTIF void en_kdtc_cal_mod0(void)
{
...
IDENTIF void dis_kdtc_cal(void)
{
...
void rf_adplldig_activate(void)
{
    ...
    // wait for some time (>8us) to stabilize before accessing the ADPLL register file
    arch_asm_delay_us(17);

    // Enable ADPLL HCLK and release the reset of ADPLL register file
    SetByte(RF_RADIO_INIT_REG + 1, (ADPLLDIG_HRESET_N | ADPLLDIG_HCLK_EN) >> 8);
}
...
void rf_adplldig_deactivate(void)
{
    ...
    // Disable ADPLL related LDOs and set ADPLLDIG_HRESET_N = 0
    SetWord16(RF_RADIO_INIT_REG, 0);
}
#endif // __EXCLUDE_ROM_RF_531__
...
{
    return rf_tx_pwr_conn_lvl[conidx];
}
#else
