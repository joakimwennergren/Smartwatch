...
#if defined (__DA14531__)
#if defined(ADC_OPT)
const adc_config_t adc_cfg_coin_bat =
{
    .adc_cfg.b.input_mode           = ADC_INPUT_MODE_SINGLE_ENDED,
    .adc_cfg.b.input                = ADC_INPUT_SE_VBAT_HIGH,
    .adc_cfg.b.smpl_time_mult       = 2,
    .adc_cfg.b.continuous           = false,
    .adc_cfg.b.interval_mult        = 0,
    .adc_cfg.b.input_attenuator     = ADC_INPUT_ATTN_4X,
    .adc_cfg.b.chopping             = false,
    .adc_cfg.b.oversampling         = 1,
};

const adc_config_t adc_cfg_alkaline_bat =
{
    .adc_cfg.b.input_mode           = ADC_INPUT_MODE_SINGLE_ENDED,
    .adc_cfg.b.input                = ADC_INPUT_SE_VBAT_LOW,
    .adc_cfg.b.smpl_time_mult       = 2,
    .adc_cfg.b.continuous           = false,
    .adc_cfg.b.interval_mult        = 0,
    ...
    .adc_cfg.b.chopping             = false,
    .adc_cfg.b.oversampling         = 1,
    .adc_cfg.b.input_shifter        = true,
    .adc_cfg.b.input_shifter_cm     = ADC_INPUT_SH_CM_1V30,
    .adc_cfg.b.input_shifter_gain   = ADC_INPUT_SH_GAIN_2X,
};
#endif // ADC_OPT
/**
 ****************************************************************************************
 ...
 ****************************************************************************************
 */
__STATIC_INLINE uint16_t battery_moving_average_filter(uint16_t new_adc_value)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE uint16_t battery_moving_average_with_reaction_filter(uint16_t new_adc_value)
{
    static uint32_t old_value __SECTION_ZERO("retention_mem_area0");
    ...
    if (old_value > (considered_big_change + new_adc_value))
        old_value = new_adc_value << filter_coefficient;
    else
 ...
 ****************************************************************************************
 */
__STATIC_INLINE uint16_t battery_filter_value(uint16_t new_adc_value)
{
...
#else
    if ((batt_type == BATT_ALKALINE) && (GetBits16(ANA_STATUS_REG, BOOST_SELECTED) == 0x1))
    {
