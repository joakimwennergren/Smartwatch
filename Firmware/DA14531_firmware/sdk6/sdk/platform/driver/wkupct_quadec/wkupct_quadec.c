...
#if (defined (__DA14531_01__) || defined (__DA14535__)) && !defined (__EXCLUDE_ROM_WKUPCT_QUADEC__)
...
void WKUP_QUADEC_Handler(void)
{
#ifndef CFG_BASIC_WKUP_CNTL_IRQ_SUPPORT_ENABLED	
    int16_t x,y,z;
#endif
...
#else //CFG_BASIC_WKUP_CNTL_IRQ_SUPPORT_ENABLED
    if (GetBits16(CLK_PER_REG, WAKEUPCT_ENABLE) && GetBits16(WKUP_IRQ_STATUS_REG, WKUP_IRQ_STATUS) && GetBits16(WKUP_CTRL_REG, WKUP_ENABLE_IRQ))
#endif //CFG_BASIC_WKUP_CNTL_IRQ_SUPPORT_ENABLED
    {
...
#if defined (__DA14535__) && defined (__EXCLUDE_ROM_WKUPCT_QUADEC__)
void wkupct_set_deb_unit_time(wkupct_deb_unit_time_t deb_unit_time_sel)
{
    SetBits16(CLK_PER_REG, WAKEUPCT_ENABLE, 1);                        // Enable clock of Wakeup controller
    SetBits16(WKUP_CTRL_REG, ENABLE_125US_CLK, deb_unit_time_sel);     // Set debounce unit time
}
#endif
