...
/// GPIO mode
// Do not modify the values since a memory optimization is based on them
typedef enum {
    /// Input
    INPUT = 0,
...
typedef enum {
    ...
    /// SPI_DATA_READY
    PID_SPI_DATA_READY = FUNC_SPI_DATA_READY,
#endif
    /// I2C_SCL
 ...
 */
        ...
        ( ((pin <= GPIO_PIN_11) && (polarity <= GPIO_POR_PIN_POLARITY_HIGH)) ? ((polarity << 7) | (pin + 1))  : \
        POR_PIN_REG_RESET )
...
#if defined (__DA14531__) && defined(GPIO_OPT)
#define RESERVE_GPIO( name, port, pin, func )   { GPIO[pin] = (GPIO[pin] != 0) ? (-1) : 1; GPIO_status |= ((uint16_t)GPIO[pin] << pin);}
#else
...
#if defined(GPIO_OPT)
extern volatile uint16_t GPIO_status;
#endif 
#else
...
#endif
#if defined(__DA14531__) && defined(GPIO_OPT)
extern int8_t GPIO[NO_OF_MAX_PINS_PER_PORT];
#else
 ...
 ****************************************************************************************
 */
void GPIO_SetPinFunctionPort0(GPIO_PIN pin, GPIO_PUPD mode, GPIO_FUNCTION function);
 ...
 ****************************************************************************************
 */
GPIO_FUNCTION GPIO_GetPinFunctionPort0(GPIO_PIN pin);
 ...
 ****************************************************************************************
 */
void GPIO_ConfigurePinPort0(GPIO_PIN pin, GPIO_PUPD mode, GPIO_FUNCTION function, const bool high);
 ...
 ****************************************************************************************
 */
void GPIO_SetActivePort0(GPIO_PIN pin);
 ...
 ****************************************************************************************
 */
void GPIO_SetInactivePort0(GPIO_PIN pin);
 ...
 ****************************************************************************************
*/
bool GPIO_GetPinStatusPort0(GPIO_PIN pin);
 ...
 ****************************************************************************************
 */
void GPIO_ConfigurePinPowerPort0(GPIO_PIN pin, GPIO_POWER_RAIL power_rail);
 ...
 ****************************************************************************************
 */
bool GPIO_is_valid_port0(GPIO_PIN pin);
 ...
 ****************************************************************************************
 */
void GPIO_EnableIRQPort0(GPIO_PIN pin,
                         IRQn_Type irq,
                         bool low_input,
                         bool release_wait,
                         uint8_t debounce_ms);
 ...
 ****************************************************************************************
 */
void GPIO_EnablePorPinPort0(GPIO_PIN pin, GPIO_POR_PIN_POLARITY polarity, uint8_t por_time);

#endif // __DA14531__ && GPIO_OPT
 ...
 ****************************************************************************************
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE void GPIO_EnableIRQ(GPIO_PORT port,
                                         GPIO_PIN pin,
                                         IRQn_Type irq,
                                         bool low_input,
                                         bool release_wait,
                                         uint8_t debounce_ms)
{ 
    GPIO_EnableIRQPort0(pin, irq, low_input, release_wait, debounce_ms);
};
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE void GPIO_SetPinFunction(GPIO_PORT port, GPIO_PIN pin, GPIO_PUPD mode,
                                GPIO_FUNCTION function) 
{ 
    GPIO_SetPinFunctionPort0(pin,  mode, function);
}
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE GPIO_FUNCTION GPIO_GetPinFunction(GPIO_PORT port, GPIO_PIN pin) {
    return GPIO_GetPinFunctionPort0(pin); 
}
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE void GPIO_ConfigurePin(GPIO_PORT port, GPIO_PIN pin, GPIO_PUPD mode,
                              GPIO_FUNCTION function, const bool high)
{
    GPIO_ConfigurePinPort0(pin, mode, function, high);
}
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE void GPIO_SetActive(GPIO_PORT port, GPIO_PIN pin) { GPIO_SetActivePort0(pin); }
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE void GPIO_SetInactive(GPIO_PORT port, GPIO_PIN pin) { GPIO_SetInactivePort0(pin); }
#else
...
*/
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE  bool GPIO_GetPinStatus(GPIO_PORT port, GPIO_PIN pin) { return GPIO_GetPinStatusPort0(pin); }
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE  void GPIO_ConfigurePinPower(GPIO_PORT port, GPIO_PIN pin, GPIO_POWER_RAIL power_rail) 
{ 
    GPIO_ConfigurePinPowerPort0(pin, power_rail);
}
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE bool GPIO_is_valid(GPIO_PORT port, GPIO_PIN pin) { return GPIO_is_valid_port0(pin); }
#else
 ...
 */
#if defined(__DA14531__) && !defined(__DA14535__) && defined(GPIO_OPT)
__STATIC_FORCEINLINE void GPIO_EnablePorPin(GPIO_PORT port, GPIO_PIN pin,
                                            GPIO_POR_PIN_POLARITY polarity, uint8_t por_time)
{ 
    GPIO_EnablePorPinPort0(pin, polarity, por_time);
}
#else
