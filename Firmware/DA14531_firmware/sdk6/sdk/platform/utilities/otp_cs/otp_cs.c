 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE int16_t calc_adc_ge(uint16_t low, uint16_t high)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE int16_t calc_adc_offset(uint16_t low, uint16_t high)
{
...
#else
SYS_INIT_PRE_RUN_ONCE_CODE int8_t otp_cs_store(void);
int8_t otp_cs_store(void)
{
