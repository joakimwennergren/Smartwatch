...
/// Default minimum RSSI Threshold - -60dBm
...
/*
 * Writable by SDK only for DA14531, DA14531-01, DA14535
 */
#if defined (__DA14531__)
extern struct supp_cmds llm_local_cmds;
#else
extern const struct supp_cmds llm_local_cmds;
#endif /* __DA14531__ */

/*
 * Writable by SDK only for DA14531-01, DA14535
 */
#if defined (__DA14531_01__) || defined (__DA14535__)
extern struct le_states llm_local_le_states;
#else
...
#else
extern struct le_features custom_llm_local_le_feats;
#endif /* __DA14531__ */
...
enum llm_rnd_addr_type
{
    ...
    /// Non-Resolvable Private Address  - 00 (MSB->LSB)
...
#define LLM_ADV_INTERVAL_MIN_NONCON_DISC        rom_cfg_table[llm_adv_interval_min_noncon_disc_pos]
...
/// States byte 2
#ifdef __DA14531_01__
#define BLE_STATES_BYTE2    (BLE_NON_CON_ADV_SLAVE_STATE | BLE_DISC_ADV_SLAVE_STATE)
#else
...
/// States byte 3
#ifdef __DA14531_01__
#define BLE_STATES_BYTE3    (BLE_LDC_DIRECT_ADV_STATE)
#else
...
/// States byte 4
#ifdef __DA14531_01__
#define BLE_STATES_BYTE4    (BLE_CON_ADV_SLAVE_SLAVE_STATE | BLE_HDC_DIRECT_ADV_SLAVE_SLAVE_STATE)
#else
...
/// States byte 5
#ifdef __DA14531_01__
#define BLE_STATES_BYTE5    (BLE_LDC_DIRECT_ADV_SLAVE_SLAVE_STATE)
#else
 ...
 * @note Implemented only for Central or Observer roles.
...
/**
 ****************************************************************************************
 * @brief This function returns the minimum RSSI value used in the Channel Assessment
 * mechanism.
 *
 ****************************************************************************************
 */
...
#if !defined (__DA14531_01__)
extern uint8_t ble_duplicate_filter_max;        // only for Central or Observer roles - not implemented in DA14531-01
extern bool ble_duplicate_filter_found;         // only for Central or Observer roles - not implemented in DA14531-01
#endif

extern bool set_adv_data_discard_old;

// DA14531-01 does not support Central or Observer roles.
// DA14531-01, DA14535 does not support the LL Privacy feature (privacy on the controller side).
#if !defined (__DA14531_01__) && !defined (__DA14535__)
...
#endif
#if defined (__DA14531_01__) || defined (__DA14535__)
void llm_wl_from_rl(struct ll_resolving_list *rls);
void llm_wl_from_rl_restore(void);
#endif
